    ...
    <!-- Main Card Container --><div class="profile-card">
        ...
        <!-- Card Content Grid --><div class="card-content">
            ...
            <!-- Left Section: Details List --><div class="detail-list">
                ...
                <!-- Name --><div class="detail-item">
                    ...
                    <p class="detail-value">{{ $client->display_name ?? '-' }}</p>
                </div>

                <!-- Contact --><div class="detail-item">
                    <p class="detail-label">Contact:</p>
                    <div class="detail-value contact-group-wrapper">
                      <a href="tel:{{ $client->mobile_number ?? '-' }}" class="contact-link flex items-center gap-1 text-blue-600 hover:underline">
                        ...
                        <a href="tel:{{ $client->phone_number ?? '-' }}" class="contact-link">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            {{ $client->phone_number ?? '-' }}
                        </a>
                       <a href="mailto:{{ $client->email ?? '-' }}" class="contact-link flex items-center gap-1 text-blue-600 hover:underline">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Gender --><div class="detail-item">
                    ...
                    <p class="detail-value" style="text-transform: capitalize;">{{ $client->gender ?? '-' }}</p>
                </div>
        ...
        <p class="detail-value">
                ...
                <!-- Marital Status --><div class="detail-item">
                    ...
                    <p class="detail-value">{{ $client->marital_status ?? '-' }}</p>
                </div>

                    <!-- Religion --><div class="detail-item">
                    <p class="detail-label">Religion:</p>
                    <p class="detail-value">{{ $client->religion ?? '-' }}</p>
                </div>

                    <!-- Nationality --><div class="detail-item">
                    <p class="detail-label">Nationality:</p>
                    <p class="detail-value">{{ $client->nationality ?? '-' }}</p>
                </div>
                ...
                <!-- Language Spoken --><div class="detail-item">
                    ...
                    <div class="detail-value language-tags">
                        @forelse($client->languages ?? [] as $language)
            ...
            <!-- Right Section: Profile Image --><div class="profile-area">
                        ...
                        @if(!empty($client->pic) && file_exists(public_path('storage/' . $client->pic)))
                            <img 
                                src="{{ asset('storage/' . $client->pic) }}" 
                                alt="Profile Picture" 
                                class="profile-image">
                        @else
                            <img 
